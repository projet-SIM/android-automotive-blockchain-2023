...
class AuthorSubmitAndWatchExtrinsic(extrinsic: String) :
    RpcMethod("author_submitAndWatchExtrinsic", JSONArray(arrayOf(extrinsic)))
...
class AccountNextIndex(key: String) :
    RpcMethod("system_accountNextIndex", JSONArray(arrayOf(key)))
